    ...
    <section className="flex flex-col w-full md:flex-row">
      ...
      <div className="flex flex-col w-[50%] px-20 py-5 text-justify space-y-5 border border-red-500">
        ...
        <p className="text-neutral-black">
          ...
          established in 1957, is an autonomous institution affiliated with Anna
      ...
      <div className="flex flex-col w-[50%] px-20 py-5 text-justify space-y-5 border border-red-500">
        ...
        <p>
          The Research Conclave 2025, "Advancing towards a Resilient convenes
          visionary leaders, innovators, and scholars to explore transformative
          solutions for sustainable development. This premier gathering
          facilitates cross-sectoral dialogue, knowledge sharing, and
          collaboration to address environmental, social, and economic
          challenges. Through keynote addresses, panel discussions and research
          presentations, participants will delve into cutting-edge themes. Join
          us in shaping a sustainable tomorrow.
        </p>
      </div>
    </section>
  );
