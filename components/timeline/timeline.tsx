...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "absolute top-[5px] left-[30px] -translate-x-1/2 translate-y-2 h-full w-px bg-primary-accent",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex flex-col size-3 bg-primary-accent rounded-full",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "text-sm text-muted-foreground max-w-sm pl-1 text-justify",
      className
    )}
    {...props}
  />
